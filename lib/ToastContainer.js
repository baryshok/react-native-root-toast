...
const TOAST_ACTIVE_OPACITY = 0.95;
const DIMENSION = Dimensions.get('window');
const DISPLAY_SHORT_SIDE_WIDTH = Math.min(DIMENSION.height, DIMENSION.width);
...
let styles = StyleSheet.create({
    ...
    containerStyle: {
        maxWidth: Math.round(DISPLAY_SHORT_SIDE_WIDTH * TOAST_MAX_WIDTH),
